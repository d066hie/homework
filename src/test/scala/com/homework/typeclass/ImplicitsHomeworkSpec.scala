...
import com.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax.GetSizeScoreOps
import com.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.{GetSizeScore, MutableBoundedCache, PackedMultiMap, SizeScore}
import com.homework.typeclass.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import com.homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
          |import com.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import com.homework.typeclass.ImplicitsHomework.MyTwitter._
